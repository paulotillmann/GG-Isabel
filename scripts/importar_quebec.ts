...
async function run() {
  console.log('Iniciando processamento do CSV Quebec (quebec - isabel.csv)...');
  ...
  const csvPath = path.resolve('importar/quebec - isabel.csv');
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    pessoasToInsert.push({
      ...
      destino: 'QUEBEC', // REGRA: destino unificado como 'QUEBEC'
      birth_date: null,

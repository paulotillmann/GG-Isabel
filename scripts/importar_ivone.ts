...
async function run() {
  console.log('Iniciando processamento do CSV Ivone (ivone - isabel.csv)...');
  ...
  const csvPath = path.resolve('importar/ivone - isabel.csv');
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    pessoasToInsert.push({
      ...
      destino: 'IVONE', // REGRA: destino unificado como 'IVONE'
      birth_date,

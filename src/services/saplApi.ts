...
// Credenciais do Gabinete da Vereadora Isabel
const USERNAME = 'isabel';
const PASSWORD = 'Mudar@123';

/**
 * Busca todas as matérias legislativas da Vereadora Isabel (autor 74)
...
export async function fetchAllSaplRequerimentos(
  ...
  while (page <= totalPages) {
    try {
      const url = `${SAPL_BASE_URL}/api/materia/materialegislativa/?autores=74&tipo=1&page_size=${PAGE_SIZE}&page=${page}`;
